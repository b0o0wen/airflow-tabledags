...
def render(template, rootdir, core_name):
    ...
    y = x.render(rootdir=rootdir, sql_path=sql_path, sh_path=sh_path, log_path=log_path, subdag_path=subdag_path, core_name=core_name, mainpy=mainpy)
